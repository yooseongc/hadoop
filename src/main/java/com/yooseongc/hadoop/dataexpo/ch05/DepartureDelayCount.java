 ...
 *
 */
public class DepartureDelayCount implements Tool {

	public int run(String[] args) {
		if (args.length != 3) {
			System.err.println("Usage: DepartureDelayCount <input> <ouput>");
		...
		try {
			...
			Job job = new Job(getConf(), DepartureDelayCount.class.getName());
			// path setting
